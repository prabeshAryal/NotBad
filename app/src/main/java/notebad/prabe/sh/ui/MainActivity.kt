...
import notebad.prabe.sh.NotebadApplication
import notebad.prabe.sh.ui.screens.FileViewerScreen
import notebad.prabe.sh.ui.theme.NotebadTheme
import notebad.prabe.sh.ui.viewmodel.FileViewerViewModel

/**
 * Main Activity for Notebad.
 *
 * Handles:
...
class MainActivity : ComponentActivity() {
    ...
    private val viewModel: FileViewerViewModel by viewModels {
        (application as NotebadApplication).viewModelFactory
    }
